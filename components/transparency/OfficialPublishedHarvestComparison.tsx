...
const COPY = {
  en: {
    ...
    lead: "A separate descriptive comparison between detected forest loss and official published harvest statistics.",
    scopeTitle: "Read these columns as different measurements",
    scope: "This project measures detected forest loss. Statistics Canada reports forest area harvested across provincial, private and federal land. These quantities are not like-for-like and the difference is not an accuracy score or a causal claim.",
  ...
  fr: {
    ...
    lead: "Une comparaison descriptive distincte entre la perte de forêt détectée et les statistiques officielles publiées sur la récolte.",
    scopeTitle: "Lire ces colonnes comme des mesures différentes",
    scope: "Ce projet mesure la perte de forêt détectée. Statistique Canada présente la superficie forestière récoltée sur les terres provinciales, privées et fédérales. Ces quantités ne sont pas directement comparables et l’écart n’est ni une mesure d’exactitude ni une affirmation causale.",
