...
const COPY = {
  en: {
    ...
    gate: "This comparison alone doesn’t pass the formal Phase 2 independent-comparison checkpoint.",
  ...
  fr: {
    ...
    gate: "Cette comparaison ne franchit pas à elle seule l’étape formelle de comparaison indépendante de la phase 2.",
