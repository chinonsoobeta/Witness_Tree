...
const COPY = {
  en: {
    ...
    coverageText: "The planned national baseline covers all Canada. British Columbia, Alberta, Ontario and Quebec are the Big Four focus provinces. Current coverage geometry is illustrative only: Quebec north of 52° resolves to national baseline, not enhanced local coverage. Coverage grades are intersected from mapped geometry, not inferred from a province label.",
  ...
  fr: {
    ...
    coverageText: "La référence nationale prévue couvre tout le Canada. La Colombie-Britannique, l’Alberta, l’Ontario et le Québec sont les quatre provinces prioritaires. La géométrie de couverture actuelle est uniquement illustrative : le Québec au nord du 52e degré est classé comme référence nationale, et non comme couverture locale enrichie. Les niveaux de couverture sont intersectés à partir d’une géométrie cartographiée, et non déduits d’une étiquette provinciale.",
