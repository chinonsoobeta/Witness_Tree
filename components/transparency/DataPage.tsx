...
const COPY = {
  en: {
    ...
    notice:
      "The source-ledger examples remain illustrative. A separate, bounded four-province 2020-2022 technical-preview release is available below.",
    ledger: "Open the illustrative source ledger",
    docs: "Read the source-ledger documentation",
    description:
      "The ledger records the dataset name, publisher, licence, version, retrieval date, coverage limits and provenance required before a public claim is published. Production ingestion must replace illustrative entries with verified source metadata and immutable archive checksums.",
    limitsTitle: "How to read this material",
    limits:
      "The source ledger describes what this product holds. It does not establish a cause, responsibility, compliance conclusion or a conclusion beyond the evidence class and confidence reason shown with a claim.",
  ...
  fr: {
    ...
    notice:
      "Les exemples du registre des sources demeurent illustratifs. Une version d’aperçu technique distincte et limitée à quatre provinces pour 2020 à 2022 est offerte ci-dessous.",
    ledger: "Ouvrir le registre illustratif des sources",
    docs: "Lire la documentation du registre des sources",
    description:
      "Le registre consigne le nom du jeu de données, l’éditeur, la licence, la version, la date de récupération, les limites de couverture et la provenance exigée avant la publication d’une affirmation publique. L’ingestion de production doit remplacer les entrées illustratives par des métadonnées de source vérifiées et des sommes de contrôle d’archives immuables.",
    limitsTitle: "Comment lire ce contenu",
    limits:
      "Le registre des sources décrit ce que détient ce produit. Il n’établit ni cause, ni responsabilité, ni conclusion de conformité, ni conclusion allant au-delà de la catégorie de preuves et de la raison de confiance affichées avec une affirmation.",
  ...
  return (
    <main id="main" className="page-wrap">
      ...
      <section className="content-section prose-measure">
        ...
        <nav aria-label={copy.title}>
          <ul className="link-list">
            ...
            <li className="card card--lift">
              <a href="https://github.com/chinonsoobeta/Witness_Tree/blob/main/docs/SOURCE_LEDGER.md">
                {copy.docs}
              </a>
            </li>
            <li className="card card--lift">
              <a
                href={
                  locale === "en"
                    ? "/en/data/official-harvest-comparison"
                    : "/fr/donnees/comparaison-recolte-officielle"
                }
              >
                {copy.comparison}
              </a>
      ...
      <section className="content-section prose-measure">
        ...
        <ul className="link-list">
          <li className="card">
            <a className="btn btn--primary" href={csv.url}>
              {copy.csv}
            </a>
            <br />
            <small>
          ...
          <li className="card">
            <a className="btn btn--primary" href={geopackage.url}>
              {copy.geopackage}
            </a>
            <br />
            <small>
      ...
      <section className="content-section prose-measure">
        ...
        <p>{copy.staging}</p>
        <nav aria-label={copy.stagingTitle}>
          <ul className="link-list">
            <li className="card card--lift">
              <a href="https://github.com/chinonsoobeta/Witness_Tree/blob/main/data/staged-acquisitions.json">
                {copy.stagingEvidence}
              </a>
            </li>
            <li className="card card--lift">
              <a href="https://github.com/chinonsoobeta/Witness_Tree/blob/main/data/staged-geospatial-profile.json">
                {copy.profileEvidence}
              </a>
            </li>
            <li className="card card--lift">
              <a href="https://github.com/chinonsoobeta/Witness_Tree/blob/main/data/transformation-runs/qc-historic-wildfire-v1-2026-08-12.json">
                {copy.transformationEvidence}
              </a>
            </li>
          </ul>
        </nav>
      ...
      <aside className="card card--sand">
