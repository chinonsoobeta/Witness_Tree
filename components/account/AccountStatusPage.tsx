...
const COPY = {
  en: {
    ...
    links: "Read the reviewed pre-activation privacy notice and terms and limitations.",
  ...
  fr: {
    ...
    links: "Consultez l’avis de confidentialité avant activation et les conditions et limites examinées.",
