...
const copy = {
  en: {
    title: "Find the ridings for an address",
    label: "Address",
    submit: "Find ridings",
    searching: "Searching",
    resolving: "Reading the riding index",
    ...
    resolveFailed: "The riding index could not be read just now.",
    federal: "Federal riding",
    provincial: "Provincial riding",
    outside: "This point is outside the area the index covers.",
    near: (names: string, metres: number) =>
      `This point is within ${metres} m of a riding boundary, so we can’t tell which side it’s on. It is in one of: ${names}.`,
