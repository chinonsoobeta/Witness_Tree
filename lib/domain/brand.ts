...
export const PRODUCT_PURPOSE: LocalizedString = Object.freeze({
  en: `A public record of forest change in British Columbia, Alberta, Ontario and Quebec from ${EXPLORE_COVERAGE_PERIOD.en}.`,
  fr: `Un registre public des changements forestiers en Colombie-Britannique, en Alberta, en Ontario et au Québec de ${EXPLORE_COVERAGE_PERIOD.fr}.`,
});
