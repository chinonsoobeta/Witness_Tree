...
export const rankedRidingFixtures: readonly RankedRiding[] = [
  { id: "r1", name: { en: "Example North", fr: "Exemple Nord" }, placeType: "federal-riding", detectedChangePercent: 4.2, detectedChangeHectares: 420, forestedHectares: 10000, coverageGrade: "national-baseline", evidence: "satellite-observation", sufficientCoverage: true },
