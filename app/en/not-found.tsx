    ...
    <SiteShell locale="en">
      <main id="main" className="page-wrap">
        <header className="masthead">
          ...
          <p className="dek">This address is not part of the public forest-change record.</p>
        </header>
        <nav className="content-section prose-measure" aria-label="Continue from this page">
          <ul className="link-list">
            <li className="card card--lift"><Link href="/en/explore">Explore forest change</Link></li>
