...
export default async function Page({ searchParams }: Readonly<{ searchParams: Promise<{ q?: string }> }>) { return <SiteShell locale="en"><main id="main" tabIndex={-1}><SearchPage locale="en" query={(await searchParams).q ?? ""} /></main></SiteShell>; }
