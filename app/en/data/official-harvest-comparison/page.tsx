...
export const metadata: Metadata = { title: "Official-source harvest comparison", alternates: { languages: { en: "/en/data/official-harvest-comparison", fr: "/fr/donnees/comparaison-recolte-officielle" } } };
