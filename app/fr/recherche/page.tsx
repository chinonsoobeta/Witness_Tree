...
export default async function Page({ searchParams }: Readonly<{ searchParams: Promise<{ q?: string }> }>) { return <SiteShell locale="fr"><main id="main" tabIndex={-1}><SearchPage locale="fr" query={(await searchParams).q ?? ""} /></main></SiteShell>; }
