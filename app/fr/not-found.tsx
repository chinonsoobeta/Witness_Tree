    ...
    <SiteShell locale="fr">
      <main id="main" className="page-wrap">
        <header className="masthead">
          ...
          <p className="dek">Cette adresse ne fait pas partie du registre public des pertes forestières.</p>
        </header>
        <nav className="content-section prose-measure" aria-label="Poursuivre à partir de cette page">
          <ul className="link-list">
            <li className="card card--lift"><Link href="/fr/explorer">Explorer les pertes forestières</Link></li>
