...
The owner-submitted FOI request `FOR-2026-056834` received a response pointing to the official BC Data Catalogue records for the two requested views and asking whether the links satisfy the request and whether the request may be withdrawn by 2026-09-01. The catalogue readback found the expected OGL-BC labels and only an indirect Custom Download route, WMS, and KML resources. It found no direct full-province package, coherent timestamped extract, complete record count, checksum, or schema profile.

The response is preserved in [`data/bc-forest-tenure-foi-catalogue-response-2026-08-27.json`](../data/bc-forest-tenure-foi-catalogue-response-2026-08-27.json). No outbound reply was sent, withdrawal is not recommended on this evidence, and both BC rows remain access-blocked with zero raw-evidence credit and no production eligibility. This supplemental response does not rewrite the historical reply audit above.
