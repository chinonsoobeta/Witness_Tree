...
> Historical checkpoint under the pre-amendment evidence rubric. The Version 2.1 national scope and current requirement states are recorded in [`V2_1_LIVE_GAP_MATRIX.md`](V2_1_LIVE_GAP_MATRIX.md). The percentage below must not be used as a current phase-completion or production-readiness claim.
