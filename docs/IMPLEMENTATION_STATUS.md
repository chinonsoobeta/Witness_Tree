...
**Status: 45% complete — technical-preview foundation with three verified staged source archives, one verified lossless local transformation, and one verified deterministic geometry repair-or-quarantine run, not a completed public-data product.**
