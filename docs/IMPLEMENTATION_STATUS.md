...
| Phase 8 | **8/16 (50%)** | Raw-archive reproducibility, the operations handbook and bounded independently retrieved bulk downloads pass. CDN and tile validation now passes as well: the deployed Site was driven in a real browser on 2026-08-30 and answered with HTTP 206 PMTiles range responses, no GeoJSON fallback fetch, and a painted loss ramp. Other operated production evidence remains incomplete. |
