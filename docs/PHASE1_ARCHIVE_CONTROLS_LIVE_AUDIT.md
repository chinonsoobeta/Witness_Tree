...
The concrete resource names, policy templates, execution sequence, recovery comparison, and cost bounds are in [PHASE1_ARCHIVE_CONTROLS_REMEDIATION_DESIGN.md](PHASE1_ARCHIVE_CONTROLS_REMEDIATION_DESIGN.md). It is an approval-gated design, not infrastructure-as-code.
