...
| `raw-archive-reproducibility` | Achievable, and hosting-independent. Needs the StatCan boundary file promoted into the archive, then a version-pinned restore and re-run of the admitted Phase 2 chain. |
