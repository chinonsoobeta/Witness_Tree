...
| 2 | Québec current/original archive | `qc-current-ecoforest`, `qc-original-current-inventory` | Exact approval is recorded. Complete/resume the owner-local run, then immediately capture and validate the mode-600 private/digest-bound redacted attestation pair before any credit change. |
