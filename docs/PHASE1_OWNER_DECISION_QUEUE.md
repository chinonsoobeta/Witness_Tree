...
| --- | --- | --- | --- |
| 1 | NBAC exact archive promotion | `cwfis-historical` | Owner authorization for acquisition and publication is recorded under current official OGL Canada metadata. The exact 1,257,052,370-byte ZIP is locally checksum-bound and profiled; exact-key IAM is applied, but storage upload and archive, transformation, ingestion, release, publication, and production admission remain false. |
