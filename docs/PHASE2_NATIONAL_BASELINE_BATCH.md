...
This increment implements the first two owner-independent Phase 2 processing batches: deterministic annual forest masks and forested-hectare denominators, followed by a deterministic annual detected-change spine over those masks.
