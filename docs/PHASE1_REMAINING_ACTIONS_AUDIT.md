...
The later canopy recovery supplied redacted exact-version and retention evidence without retaining provider identifiers. The canonical baseline is now **15.25/31 (39.7580645%)**, with **11 remote / 5 local / 2 partial / 13 access-blocked** rows, **11 immutable rows**, **0/31 production admission**, and the unchanged **4/6 current-wildfire** gate.
