...
| --- | --- | --- |
| Editorial-board sign-off | Recorded approval of the forest definition, evidence classes, and confidence rules | Not started; no editorial board has been appointed |
...
| Mistik name request | Written response from the appropriate Cree language authority, including terms, spelling, honorarium, and withdrawal rights; outcome recorded | Not requested; nothing ships under this name |
...
## Phases 1–4 — sources, methods, and provincial presentation
...
| Editorial and technical method sign-off | Recorded decisions for definitions, new sources, methods, and published-number changes | Not started; required before published-number releases |

## Phases 5–7 — operational and Indigenous-geography gates
...
## Phases 8–9 — release, beta, and launch
