...
`.github/workflows/ci.yml` runs on every push and pull request with default
read permissions. It deploys nothing and has no cloud credentials.
...
them against bound checksums. While the drive is detached, those nineteen
