...
Nine gates remain closed: professional bilingual review, independent accessibility audit, security review, measured load test, complete production source-rights/licence/attribution review, on-call rota, observability, backups, and complete CDN/tile validation. The six precise external blockers are intentionally retained in the status record.
