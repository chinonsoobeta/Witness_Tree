...
export function validateElectionsCanadaFed2025PromotionPreparation(plan, ledger, profile, readiness) {
  ...
  assert.deepEqual(plan.executionGates, {
    ...
    requiredBeforeMutation: [
      ...
      "A separately captured exact finite raw IAM response inventory is file-backed, recomputed, and digest-linked before any future mutation implementation may be reviewed.",
