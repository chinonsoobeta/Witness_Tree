#!/usr/bin/env bash
# Builds the arbitrary-interval loss product for the three reference frameworks
# the riding runner does not cover: provinces, Statistics Canada economic regions
# and the Water Survey of Canada sub-drainage areas.
#
...
OUT="$DATA_ROOT/derived/phase3-interval-framework-zonal-v1"
...
WORKERS="${WITNESS_TREE_INTERVAL_WORKERS:-10}"
...
run_one provinces-2021-cbf CA \
  "/vsizip/$DATA_ROOT/raw/statcan-boundaries/2026-08-12/lpr_000b21a_e.zip/lpr_000b21a_e.shp" \
  PRUID PRENAME statcan-provinces-2021-cbf

run_one economic-regions-2021 CA \
  "$DATA_ROOT/raw/statcan-economic-regions-2021/2026-08-29/ler_000a21s_e.geojson" \
  ERUID ERNAME statcan-economic-regions-2021

run_one watersheds-wsc-sda-v6 CA \
  "/vsizip/$DATA_ROOT/raw/nrcan-wsc-sub-drainage-v6/2026-08-29/canadwscsda_p_1m_v6-0_shp.zip" \
  WSCSDA WSCSDA_EN wsc-sub-drainage-areas-v6

echo "all three framework interval summaries complete"
