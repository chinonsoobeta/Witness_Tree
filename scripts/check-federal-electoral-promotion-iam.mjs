...
const ROLE_SESSION_ARN = `arn:aws:sts::${ACCOUNT}:assumed-role/WitnessTreeFederalElectoralPromotionUploader/witness-tree-federal-electoral-promotion`;
...
export function validateFederalElectoralPromotionIam(desired, plan) {
  ...
  assert.equal(desired.roleName, "WitnessTreeFederalElectoralPromotionUploader");
