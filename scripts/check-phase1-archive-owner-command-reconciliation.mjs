...
export function validatePhase1ArchiveOwnerCommandReconciliation(record = read()) {
  ...
  assert.match(record.quebecFourth.executeTemplate, /--session-ready/);
  assert.match(record.quebecFourth.executeTemplate, /<controlled-absolute-path>/);
  assert.doesNotMatch(record.quebecFourth.executeTemplate, /--mfa-code|--mfa-serial/);
