...
const MAIN_COMPONENTS = new Set(["AccountStatusPage", "ComponentGallery", "DataPage", "GovernancePage", "LocationResult", "MethodologyPage", "PlacePage", "PublicContentPage", "WildfireView"]);
