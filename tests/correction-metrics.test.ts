...
import { correctionMetrics } from "../lib/corrections/metrics";
import { EXAMPLE_CORRECTION } from "../lib/corrections/fixtures";
import type { CorrectionCase } from "../lib/corrections/types";
...
test("invalid or incomplete production cases do not become metrics", () => {
  ...
  assert.throws(() => correctionMetrics([production("missing-resolution", "critical", "resolved", "2026-08-01T00:00:00Z")]), /resolution timestamp/);
});
