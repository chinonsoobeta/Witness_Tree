...
test("decision-readiness matrix reconciles all rows and stays strictly non-admitting", () => {
  ...
  assert.deepEqual(audit.counts, { "owner-decision-recorded": 4, "immutable-archive-then-owner-decision": 6, "owner-scope-decision-after-archive": 4, "owner-scope-decision-ready": 1, "external-evidence-blocked": 16 });
