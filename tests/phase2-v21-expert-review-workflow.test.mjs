...
test("canonical workflow is ready with exactly 100 assignments per province and no approved roster", () => {
...
test("only checksum-bound approved human roster coverage can aggregate all provincial assignments", () => {
...
test("400 all-indeterminate rows cannot complete even with per-row reasons", () => {
...
test("workflow fails closed on omitted roster, unqualified identity, independence, notes, evidence, source binding, and incomplete assignment", () => {
