...
test("recorded admission fails closed when staged metadata disagrees", () => {
  ...
  assert.equal(validateRecordedLocalAdmissions({ ...acquisitions, entries: [...acquisitions.entries, { ...acquisitions.entries[0], id: "unprofiled-source", sourceId: "unprofiled-source" }] }, profile).length, 2);
